...
describe('validateOAuthCredentials', () => {
	...
	it('throws if credentials is not an object', () => {
		expect(() => validateOAuthCredentials(null)).toThrow('Credentials must be an object')
		expect(() => validateOAuthCredentials('not an object')).toThrow('Credentials must be an object')
	})
	...
	it('throws if required field is missing', () => {
		...
		expect(() => validateOAuthCredentials(creds)).toThrow('Missing required field: client_secret')
	})
	...
	it('throws if redirect_uris is not an array', () => {
		...
		expect(() => validateOAuthCredentials(creds)).toThrow('redirect_uris must be an array')
	})
	...
	it('throws if string field is not a string', () => {
		...
		expect(() => validateOAuthCredentials(creds)).toThrow('client_id must be a string')
	})
	...
	it('supports custom required fields', () => {
		...
		expect(() => validateOAuthCredentials(creds, ['client_id', 'client_secret'])).not.toThrow()
