...
describe('transaction', () => {
	describe('Transaction', () => {
		...
		test('rolls back on failure', async () => {
			...
			tx.add(createFailingOperation('op2', 'op2 failed', () => rollbacks.push('op2')))
		...
		test('rolls back in reverse order', async () => {
			...
			tx.add(createOperation('op1', undefined, () => rollbackOrder.push('op1')))
			tx.add(createOperation('op2', undefined, () => rollbackOrder.push('op2')))
			tx.add(createFailingOperation('op3', 'fail', () => rollbackOrder.push('op3')))
		...
		test('continues rollback even if rollback fails', async () => {
			...
			tx.add(createFailingOperation('op3', 'Execute failed', () => rollbacks.push('op3')))
