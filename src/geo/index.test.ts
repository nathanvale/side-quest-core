...
describe('generateAppleMapsUrl', () => {
	...
	test('generates URL with place name', () => {
		const url = generateAppleMapsUrl(-33.8567844, 151.2127164, 'Sydney Opera House')
		expect(url).toBe('maps://?ll=-33.8567844,151.2127164&q=Sydney%20Opera%20House')
	})
...
describe('generateAppleMapsWebUrl', () => {
	...
	test('generates https URL with place name', () => {
		const url = generateAppleMapsWebUrl(-33.8567844, 151.2127164, 'Sydney Opera House')
		expect(url).toBe('https://maps.apple.com/?ll=-33.8567844,151.2127164&q=Sydney%20Opera%20House')
	})
})
...
describe('generateGoogleMapsUrl', () => {
	test('generates search URL with coordinates', () => {
		...
		expect(url).toBe('https://www.google.com/maps/search/?api=1&query=-33.8567844,151.2127164')
	})

	test('generates same URL with place name (name not used)', () => {
		const url = generateGoogleMapsUrl(-33.8567844, 151.2127164, 'Sydney Opera House')
		expect(url).toBe('https://www.google.com/maps/search/?api=1&query=-33.8567844,151.2127164')
	})
})
...
describe('generateGoogleMapsSearchUrl', () => {
	test('generates search URL with place name', () => {
		...
		expect(url).toBe('https://www.google.com/maps/search/?api=1&query=Sydney%20Opera%20House')
	})
...
describe('parseMapUrl', () => {
	test('parses Google Maps URL', () => {
		const url = 'https://www.google.com/maps/place/Sydney+Opera+House/@-33.8567844,151.2127164,17z'
...
describe('isGoogleMapsUrl', () => {
	test('returns true for google.com/maps URLs', () => {
		expect(isGoogleMapsUrl('https://www.google.com/maps/place/Sydney')).toBe(true)
	})
...
describe('isAppleMapsUrl', () => {
	...
	test('returns true for maps.apple.com URLs', () => {
		expect(isAppleMapsUrl('https://maps.apple.com/?ll=-33.8567844,151.2127164')).toBe(true)
	})
