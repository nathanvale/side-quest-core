 ...
 *
 * @deprecated Terminal utilities - Import from "@side-quest/core/terminal" instead
 *
 * @example
 * ```ts
 * // Preferred (new code - terminal utilities):
 * import { OutputFormat, parseOutputFormat, emphasize, color } from "@side-quest/core/terminal";
 *
 * // Legacy (still works):
 * import { OutputFormat, parseOutputFormat, emphasize, color } from "@side-quest/core/formatters";
 *
 * // New formatter utilities:
 * import { formatBytes, getLanguageForExtension } from "@side-quest/core/formatters";
 * ```
 */
