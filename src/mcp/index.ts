 ...
 *
 * Forked into @side-quest/core to fix ToolOptions type (missing annotations field)
 ...
 * ```ts
 * import { startServer, log, createCorrelationId } from "@side-quest/core/mcp";
 *
