...
import { validateClassifierId, validateFieldName, validateTemplateName } from './identifiers.ts'
...
describe('validation/identifiers', () => {
	describe('validateClassifierId', () => {
		test('accepts valid kebab-case IDs', () => {
			...
			expect(validateClassifierId('medical-statement-2024')).toBe('medical-statement-2024')
		})
	...
	describe('validateTemplateName', () => {
		test('accepts valid kebab-case names', () => {
			...
			expect(validateTemplateName('travel-booking-v2')).toBe('travel-booking-v2')
		})
