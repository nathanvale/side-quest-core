...
describe('validateShellSafePattern', () => {
	describe('accepts safe patterns', () => {
		...
		test('file paths', () => {
			...
			expect(() => validateShellSafePattern('test/unit/auth.test.ts')).not.toThrow()
		})
	...
	describe('rejects patterns with shell metacharacters', () => {
		...
		test('backtick command substitution', () => {
			...
			expect(() => validateShellSafePattern('test `cat /etc/passwd`')).toThrow()
		})
	...
	describe('edge cases', () => {
		...
		test('pattern with multiple metacharacters', () => {
			expect(() => validateShellSafePattern('; rm -rf / && echo done | tee log')).toThrow()
		})
